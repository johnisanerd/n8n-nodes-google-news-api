...
import { properties } from './ApifyGoogleNews.properties';
import { runActor } from './helpers/executeActor';

// SNIPPET 1: Make sure the constants are correct
export const ACTOR_ID = 'itMT9aXhvbNwasFYH' as string;

export const PACKAGE_NAME = 'n8n-nodes-google-news-api' as string;
export const CLASS_NAME = 'ApifyGoogleNews' as string;
...
export const X_PLATFORM_APP_HEADER_ID = 'google-news-app' as string;

export const DISPLAY_NAME = 'Google News' as string;
export const DESCRIPTION =
	'Search Google News and return articles with titles, sources, snippets, dates, and links' as string;

export class ApifyGoogleNews implements INodeType {
